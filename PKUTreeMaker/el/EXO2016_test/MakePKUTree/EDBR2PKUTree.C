...
*/
                if (ptlep1>50.)
                   {if (etalep1<-2.0){IDweight=0.968;}
                    else if (etalep1<-1.56){IDweight=0.955;}
                    else if (etalep1<-1.44){IDweight=0.961;}
                    else if (etalep1<-0.8){IDweight=0.967;}
                    else if (etalep1<0.0){IDweight=0.952;}
                    else if (etalep1<0.8){IDweight=0.960;}
                    else if (etalep1<1.44){IDweight=0.960;}
                    else if (etalep1<1.56){IDweight=0.933;}
                    else if (etalep1<2.0){IDweight=0.963;}
                    else if (etalep1>=2.0){IDweight=0.967;}
                   }

                IDweightISO=1.0;

                IDweighttrk=1.0;
                   if (etalep1<-2.4){IDweighttrk=1.17;}
                   else if(etalep1<-2.3){IDweighttrk=1.009;}
                   else if(etalep1<-2.2){IDweighttrk=1.010;}
                   else if(etalep1<-2.0){IDweighttrk=1.005;}
                   else if(etalep1<-1.8){IDweighttrk=0.998;}
                   else if(etalep1<-1.63){IDweighttrk=0.992;}
                   else if(etalep1<-1.566){IDweighttrk=0.986;}
                   else if(etalep1<-1.444){IDweighttrk=0.962;}
                   else if(etalep1<-1.2){IDweighttrk=0.987;}
                   else if(etalep1<-1.){IDweighttrk=0.978;}
                   else if(etalep1<-0.6){IDweighttrk=0.969;}
                   else if(etalep1<-0.4){IDweighttrk=0.966;}
                   else if(etalep1<-0.2){IDweighttrk=0.963;}
                   else if(etalep1<0.0){IDweighttrk=0.960;}
                   else if(etalep1<0.2){IDweighttrk=0.966;}
                   else if(etalep1<0.4){IDweighttrk=0.980;}
                   else if(etalep1<0.6){IDweighttrk=0.977;}
                   else if(etalep1<1.0){IDweighttrk=0.981;}
                   else if(etalep1<1.2){IDweighttrk=0.987;}
                   else if(etalep1<1.444){IDweighttrk=0.987;}
                   else if(etalep1<1.566){IDweighttrk=0.971;}
                   else if(etalep1<1.63){IDweighttrk=0.990;}
                   else if(etalep1<1.8){IDweighttrk=0.996;}
                   else if(etalep1<2.0){IDweighttrk=0.990;}
                   else if(etalep1<2.2){IDweighttrk=0.995;}
                   else if(etalep1<2.3){IDweighttrk=0.993;}
                   else if(etalep1<2.4){IDweighttrk=0.967;}
                   else if(etalep1<2.5){IDweighttrk=0.884;}
...
//--BSF----------------------------
                ...
                weight=lumiWeight*triggerWeight*eff_and_pu_Weight*nn*trigger_eff*btagweight_center*IDweight*IDweightISO*IDweighttrk;
//                std::cout<<IDweight<<"        "<<btagweight_center<<"	"<<trigger_eff<<std::endl;
		...
		tmp_categoryID_channel=-1;// -1 for el; 1 for mu
			...
			//LP: 0.5<tau21<=0.75;
			if ( lep==11 && nLooseLep==1 && ptlep1>55 && fabs(etalep1)<2.5 && MET_et>80 && ptVlepJEC > 200.  && ptVhad>200 && fabs(yVhad)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && tau21>0.45 && tau21<=0.75 && (( massVhadJEC >40 &&  massVhadJEC< 150 )) )
			{ isAnaLP=1.; } 
			else{ isAnaLP=-1.; }
			//NP: 0.75<tau21
			if ( lep==11 && nLooseLep==1 && ptlep1>55 && fabs(etalep1)<2.5 && MET_et>80 && ptVlepJEC > 200.  && ptVhad>200 && fabs(yVhad)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && tau21>0.75 && (( massVhadJEC >40 &&  massVhadJEC< 150 )) )
			{ isAnaNP=1.; } 
			else{ isAnaNP=-1.; }


			//TTbar control
			if ( lep==11 && nLooseLep==1 && ptlep1>55 && fabs(etalep1)<2.5 && MET_et>80 && ptVlepJEC > 200. &&ptVhad>200 && fabs(yVhad)<2.4 && IDLoose>0  && num_bJet>0 &&  massVhadJEC>40 && massVhadJEC <150)
			{ isTTBarControl=1.; } 
		...
		tmp_categoryID_channel=1;// -1 for el; 1 for mu
			//HP: 0<tau21<=0.5;
			if (isAnaHP>0 && lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.1 && nLooseLep==1 ) { nID_mu = nID_mu+1; } else{ isAnaHP=-1; }
			...
			//LP: 0.5<tau21<=0.75;
			if (lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.1 && nLooseLep==1 && ptlep1>50 && MET_et>40 && ptVlepJEC>200 && ptVhad>200 && fabs(yVhad)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && tau21>0.45 && tau21<=0.75 && (( massVhadJEC >40&& massVhadJEC< 150 )))
			{ isAnaLP=1.; } 
			else{ isAnaLP=-1.; }

			//NP: 0.75<tau21;
			if (lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.1 && nLooseLep==1 && ptlep1>50 && MET_et>40 && ptVlepJEC>200 && ptVhad>200 && fabs(yVhad)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && tau21>0.75  && (( massVhadJEC >40&& massVhadJEC< 150 )))
			{ isAnaNP=1.; } 
			else{ isAnaNP=-1.; }

			//TTbar control
			if (lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.1 && nLooseLep==1 && ptlep1>50 && MET_et>40 && ptVlepJEC>200 && ptVhad>200 && fabs(yVhad)<2.4 && IDLoose>0 && num_bJet>0 && massVhadJEC>40 && massVhadJEC <150)
			{ isTTBarControl=1.; } 
			else{ isTTBarControl=-1.; }
