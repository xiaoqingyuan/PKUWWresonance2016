void MakePseudoData_ST(TString channel) {

	Double_t lumi=12.9;

	//Get old file, old tree and set top branch address
	TFile *oldfile = new TFile(channel+"_PKUTree_SingleTop_xww.root");
	...
	TFile *newfile = new TFile(channel+"_PKUTree_pdata_ST.root","recreate");
