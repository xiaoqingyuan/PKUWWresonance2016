			...
			if(npT < weights_pu2.size()){
                ...
                if (ptlep1>50 && ptlep1<60)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.975;}
                    ...
                    else if (fabs(etalep1)<2.1){trigger_eff=0.886;}
                   }
                else if (ptlep1>60 && ptlep1<80)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.972;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.935;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.883;}
                   }
                else if (ptlep1>80 && ptlep1<120)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.966;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.902;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.85;}
                   }
                else if (ptlep1>120 && ptlep1<180)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.899;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.813;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.794;}
                   }
                else if (ptlep1>180)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.89;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.75;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.65;}
                   }
