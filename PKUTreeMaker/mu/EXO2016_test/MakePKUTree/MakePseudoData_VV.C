void MakePseudoData_VV(TString channel) {

	Double_t lumi=12.9;

	//Get old file, old tree and set top branch address
	TFile *oldfile = new TFile(channel+"_PKUTree_VV_xww.root");
	...
	TFile *newfile = new TFile(channel+"_PKUTree_pdata_VV.root","recreate");
