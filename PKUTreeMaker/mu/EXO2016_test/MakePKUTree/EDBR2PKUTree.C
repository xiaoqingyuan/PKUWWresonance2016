...
*/
      ...
      IDweight=1.0;
               if (ptlep1>50 && ptlep1<60)
                   {if (fabs(etalep1)<0.9){IDweight=0.9723;}
                    else if (fabs(etalep1)<1.2){IDweight=0.9715;}
                    else if (fabs(etalep1)<2.1){IDweight=0.9916;}
                    else if (fabs(etalep1)<2.4){IDweight=0.9811;}
                   }
                else if (ptlep1>=60 && ptlep1<100)
                   {if (fabs(etalep1)<0.9){IDweight=0.9735;}
                    else if (fabs(etalep1)<1.2){IDweight=0.9682;}
                    else if (fabs(etalep1)<2.1){IDweight=0.9898;}
                    else if (fabs(etalep1)<2.4){IDweight=0.9752;}
                   }
                else if (ptlep1>=100)
                   {if (fabs(etalep1)<0.9){IDweight=0.9876;}
                    else if (fabs(etalep1)<1.2){IDweight=1.0271;}
                    else if (fabs(etalep1)<2.1){IDweight=1.0135;}
                    else if (fabs(etalep1)<2.4){IDweight=0.9181;}
                   }

      IDweightISO=1.0;
               if (ptlep1>50 && ptlep1<60)
                   {if (fabs(etalep1)<0.9){IDweightISO=0.9965;}
                    else if (fabs(etalep1)<1.2){IDweightISO=0.9994;}
                    else if (fabs(etalep1)<2.1){IDweightISO=0.9990;}
                    else if (fabs(etalep1)<2.4){IDweightISO=0.9979;}
                   }
                else if (ptlep1>=60 && ptlep1<100)
                   {if (fabs(etalep1)<0.9){IDweightISO=0.9990;}
                    else if (fabs(etalep1)<1.2){IDweightISO=0.9995;}
                    else if (fabs(etalep1)<2.1){IDweightISO=0.9984;}
                    else if (fabs(etalep1)<2.4){IDweightISO=1.001;}
                   }
                else if (ptlep1>=100)
                   {if (fabs(etalep1)<0.9){IDweightISO=1.0000;}
                    else if (fabs(etalep1)<1.2){IDweightISO=0.9957;}
                    else if (fabs(etalep1)<2.1){IDweightISO=1.0057;}
                    else if (fabs(etalep1)<2.4){IDweightISO=0.9986;}
                   }
